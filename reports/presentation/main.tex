...
\begin{frame}
	...
	\begin{figure}
		\raggedleft
		\includegraphics[width=7cm]{punctuality.jpg}
		\vspace{-2mm}
		\caption*{\raggedleft \tiny\href{https://schlechtewitze.com/static/media/681cd185b3eb129e934bd2bb.jpg}{(Source)}}
	\end{figure}
...
\begin{frame}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.38\textwidth}
			...
			\includegraphics[width=\linewidth, scale=0.5]{track.jpg}
			
			\vspace{-1mm}
			\makebox[\linewidth][r]{%
				\tiny
				\href{https://schlechtewitze.com/static/media/69f25850985731140a02e36e.jpg}
				{(Source)}%
			}
		\end{column}
	\end{columns}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[$\rightarrow$] Less re-proving necessary
		\end{itemize}
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[$\rightarrow$] successful use of forwarded information
		\end{itemize}
	\end{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[$\rightarrow$] Time Prio struggles with direct translation of original plan
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item[$\rightarrow$] First Plan Prio is faster BUT...
		\end{itemize}
...
\begin{frame}{Differences in Output Quality}
\begin{figure}
