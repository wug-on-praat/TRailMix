...
\begin{figure}[hbt!]
	...
	\begin{subfigure}{.475\linewidth}
		...
		\caption{20x15, 2 agents}
		\label{dense}
	\end{subfigure}
	
	\par \medskip % create some *vertical* separation between the graphs
	\begin{subfigure}{.475\linewidth}
...
\caption{Running times for different malfunction and rescheduling configurations.}
...
\noindent
Here, $T_{\mathrm{ground}}$, $T_{\mathrm{solve}}$, and $T_{\mathrm{res}}$
